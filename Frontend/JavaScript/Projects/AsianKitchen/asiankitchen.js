...
// Button'lar için bir dizi oluşturur
const buttons = ["All", "Korea", "Japan", "China"];

// Menü öğelerini oluşturan işlev
...
// Button'ları başlangıçta oluştur
generateButtonItems();
...
btnContainer.addEventListener("click", e => {
  if (e.target.tagName === "BUTTON") {
    ...
    generateMenuHTML(filteredItems);
  }
});
